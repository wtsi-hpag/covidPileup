...
function plotcmd
{
	...
	printf "set ylabel \"SNP Pileup Frequency / 100 \"\n"
	printf "plot [ 0 to 30000 ] [ 1 to 100 ] \"public-pileupSNP.freq\" title \"COVID-19 Public: 368 genomes\" with lines ls 1, \"sample-pileupSNP.freq\" title \"COVID-19 Sample: 1439 genomes\" with lines ls 2"
}
