...
function plotcmd
{
	...
	printf "set xlabel \"Number of SNPs \"\n"
	printf "set ylabel \" SNP Frequency / 100 \"\n"
	printf "plot [ 0 to 16 ] [ 1 to 100 ] \"public-frequeSNP.freq\" title \"COVID-19 Public: 369 genomes\" with lines ls 1, \"sample-frequeSNP.freq\" title \"COVID-19 Sample: 1439 genomes\" with lines ls 2"
}
